...
#> # Database: DuckDB 1.5.1 [unknown@Linux 6.17.0-1010-azure:R 4.5.3//tmp/RtmpFG6Oqm/file2cc44bdb09d8.duckdb]
#>       x y    
#>   <int> <chr>
#> 1     1 a    
#> 2     2 b    
...
with [`db_exec()`](https://duckplyr.tidyverse.org/reference/db_exec.md):
