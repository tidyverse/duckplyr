...
methods_overwrite <- function() {
  ...
  vctrs::s3_register("dplyr::group_by", "data.frame", duckplyr:::group_by.duckplyr_df)
  vctrs::s3_register("dplyr::group_data", "data.frame", duckplyr:::group_data.duckplyr_df)
  vctrs::s3_register("dplyr::group_indices", "data.frame", duckplyr:::group_indices.duckplyr_df)
  vctrs::s3_register("dplyr::group_keys", "data.frame", duckplyr:::group_keys.duckplyr_df)
  vctrs::s3_register("dplyr::group_map", "data.frame", duckplyr:::group_map.duckplyr_df)
  vctrs::s3_register("dplyr::group_modify", "data.frame", duckplyr:::group_modify.duckplyr_df)
  vctrs::s3_register("dplyr::group_nest", "data.frame", duckplyr:::group_nest.duckplyr_df)
  vctrs::s3_register("dplyr::group_size", "data.frame", duckplyr:::group_size.duckplyr_df)
  vctrs::s3_register("dplyr::group_split", "data.frame", duckplyr:::group_split.duckplyr_df)
  vctrs::s3_register("dplyr::group_trim", "data.frame", duckplyr:::group_trim.duckplyr_df)
  vctrs::s3_register("dplyr::group_vars", "data.frame", duckplyr:::group_vars.duckplyr_df)
  vctrs::s3_register("dplyr::groups", "data.frame", duckplyr:::groups.duckplyr_df)
  ...
  vctrs::s3_register("dplyr::n_groups", "data.frame", duckplyr:::n_groups.duckplyr_df)
  ...
  vctrs::s3_register("dplyr::rowwise", "data.frame", duckplyr:::rowwise.duckplyr_df)
