...
test_that("mutating joins don't trigger multiple match warning when called indirectly", {
  ...
  fn <- function(df1, df2, multiple = NULL) {
    duckplyr_left_join(df1, df2, join_by(x), multiple = multiple)
  }
...
test_that("joins preserve groups", {
  ...
  i <- count_regroups(out <- duckplyr_inner_join(gf1, gf2, by = "a", multiple = "all"))
  expect_equal(i, 1L)
...
test_that("joins respect zero length groups", {
  ...
  expect_equal(duckplyr_group_size(duckplyr_left_join( df1, df2, by = "f", multiple = "all")),  c(2,4))
  expect_equal(duckplyr_group_size(duckplyr_right_join( df1, df2, by = "f", multiple = "all")),  c(4,2))
  expect_equal(duckplyr_group_size(duckplyr_full_join( df1, df2, by = "f", multiple = "all")),  c(2,4,2))
  expect_equal(duckplyr_group_size(duckplyr_anti_join( df1, df2, by = "f")),  c(2))
  expect_equal(duckplyr_group_size(duckplyr_inner_join( df1, df2, by = "f", multiple = "all")),  c(4))
  ...
  expect_equal(duckplyr_group_size(duckplyr_left_join( df1, df2, by = "f", multiple = "all")),  c(2,4,0))
  expect_equal(duckplyr_group_size(duckplyr_right_join( df1, df2, by = "f", multiple = "all")),  c(0,4,2))
  expect_equal(duckplyr_group_size(duckplyr_full_join( df1, df2, by = "f", multiple = "all")),  c(2,4,2))
  expect_equal(duckplyr_group_size(duckplyr_anti_join( df1, df2, by = "f")),  c(2,0,0))
  expect_equal(duckplyr_group_size(duckplyr_inner_join( df1, df2, by = "f", multiple = "all")),  c(0,4,0))
})
...
test_that("rowwise group structure is updated after a join (#5227)", {
  ...
  x <- duckplyr_left_join(df1, df2, by = "x", multiple = "all")
