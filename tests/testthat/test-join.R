...
test_that("joins respect zero length groups", {
  ...
  expect_equal(group_size(duckplyr_left_join( df1, df2, by = "f", multiple = "all")),  c(2,4))
  expect_equal(group_size(duckplyr_right_join( df1, df2, by = "f", multiple = "all")),  c(4,2))
  expect_equal(group_size(duckplyr_full_join( df1, df2, by = "f", multiple = "all")),  c(2,4,2))
  expect_equal(group_size(duckplyr_anti_join( df1, df2, by = "f")),  c(2))
  expect_equal(group_size(duckplyr_inner_join( df1, df2, by = "f", multiple = "all")),  c(4))
  ...
  expect_equal(group_size(duckplyr_left_join( df1, df2, by = "f", multiple = "all")),  c(2,4,0))
  expect_equal(group_size(duckplyr_right_join( df1, df2, by = "f", multiple = "all")),  c(0,4,2))
  expect_equal(group_size(duckplyr_full_join( df1, df2, by = "f", multiple = "all")),  c(2,4,2))
  expect_equal(group_size(duckplyr_anti_join( df1, df2, by = "f")),  c(2,0,0))
  expect_equal(group_size(duckplyr_inner_join( df1, df2, by = "f", multiple = "all")),  c(0,4,0))
})
