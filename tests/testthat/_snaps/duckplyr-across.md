# duckplyr_expand_across() successful
    ...
    Code
      test_duckplyr_expand_across(tibble::tibble(x = 0, y = 0), across(x:y, mean))
    Output
...
---
    ...
    Code
      test_duckplyr_expand_across(tibble::tibble(x = 0, y = 0), across(x:y, function(
        x) mean(x)))
    Output
...
---
    ...
    Code
      test_duckplyr_expand_across(tibble::tibble(x = 0, y = 0), across(c(x_mean = x,
        y_mean = y), mean))
    Output
...
---
    ...
    Code
      test_duckplyr_expand_across(tibble::tibble(x = 0, y = 0, a = 0), across(c(a, x),
      function(x) x + 1))
    Output
      tibble(a = a + 1, x = x + 1)
...
---
    ...
    Code
      test_duckplyr_expand_across(tibble::tibble(x = 0, y = 0, a = 0), across(-a,
        function(x) x * x))
    Output
      tibble(x = x * x, y = y * y)
...
---
    ...
    Code
      test_duckplyr_expand_across(tibble::tibble(x = 0, y = 0), across(x:y, base::mean))
    Output
      tibble(x = base::mean(x), y = base::mean(y))
...
---
    ...
    Code
      test_duckplyr_expand_across(tibble::tibble(x = 0, y = 0), across(x:y, list(mean)))
    Output
...
# duckplyr_expand_across() with identity
    ...
    Code
      test_duckplyr_expand_across(tibble::tibble(x = 0, y = 0), across(x:y, identity))
    Output
