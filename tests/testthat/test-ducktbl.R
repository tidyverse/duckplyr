...
test_that('.inert = "always" forbids materialization', {
...
test_that('.inert = "always" forbids materialization for as_duckdb_tibble', {
  tbl <- as_duckdb_tibble(data.frame(a = 1), inert = "always")
  expect_error(length(tbl$a))
})
