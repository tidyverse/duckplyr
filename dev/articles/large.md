...
#> ℹ /tmp/Rtmpiqqo0C/duckdb/extensions
...
dbplyr_data
#> # A query:  ?? x 2
#> # Database: DuckDB 1.5.4 [unknown@Linux 7.0.0-1009-azure:R 4.6.1//tmp/Rtmpiqqo0C/file3cfd4d72de2.duckdb]
#>       x y    
#>   <int> <chr>
#> 1     1 a    
#> 2     2 b    
