...
non_force_only_tests <- head(
  ...
  list(
    `test-across.R` = c(
      ...
      "across() works sequentially (#4907)",
      "across() retains original ordering",
      ...
      "across() predicates operate on whole data",
      "selects and combines columns",
    ...
    `test-arrange.R` = c(
      ...
      "arrange handles list columns (#282)",
      "arrange handles raw columns (#1803)",
    ...
    `test-filter.R` = c(
      ...
      "filter and filter_out propagate attributes",
      ...
      "duckplyr_filter() and duckplyr_filter_out() handle named logical (#4638)",
      "duckplyr_filter() and duckplyr_filter_out() allow 1 dimension arrays",
