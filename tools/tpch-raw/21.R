...
"semi_join"
rel6 <- duckdb$rel_from_df(con, df1)
"semi_join"
...
df2 <- orders
"inner_join"
rel11 <- duckdb$rel_from_df(con, df2)
"inner_join"
rel12 <- duckdb$rel_set_alias(
  rel11,
  "rhs"
)
"inner_join"
...
"semi_join"
rel19 <- duckdb$rel_from_df(con, df1)
"semi_join"
...
df3 <- supplier
"inner_join"
rel23 <- duckdb$rel_from_df(con, df3)
"inner_join"
...
df4 <- nation
"inner_join"
rel30 <- duckdb$rel_from_df(con, df4)
"inner_join"
