...
"inner_join"
rel25 <- duckdb$rel_set_alias(
  rel18,
  "lhs"
)
"inner_join"
rel26 <- duckdb$rel_set_alias(
  rel24,
  "rhs"
)
"inner_join"
...
"inner_join"
rel57 <- duckdb$rel_set_alias(
  rel56,
  "lhs"
)
"inner_join"
rel58 <- duckdb$rel_set_alias(
  rel16,
  "rhs"
)
"inner_join"
