...
df3 <- customer
"select"
rel18 <- duckdb$rel_from_df(con, df3)
"select"
...
df4 <- orders
"select"
rel28 <- duckdb$rel_from_df(con, df4)
"select"
...
"inner_join"
rel34 <- duckdb$rel_set_alias(
  rel33,
  "lhs"
)
"inner_join"
rel35 <- duckdb$rel_set_alias(
  rel27,
  "rhs"
)
"inner_join"
...
df5 <- lineitem
"select"
rel42 <- duckdb$rel_from_df(con, df5)
"select"
...
df6 <- part
"select"
rel52 <- duckdb$rel_from_df(con, df6)
"select"
...
"inner_join"
rel59 <- duckdb$rel_set_alias(
  rel51,
  "lhs"
)
"inner_join"
rel60 <- duckdb$rel_set_alias(
  rel58,
  "rhs"
)
"inner_join"
...
df7 <- supplier
"select"
rel67 <- duckdb$rel_from_df(con, df7)
"select"
...
"inner_join"
rel69 <- duckdb$rel_set_alias(
  rel66,
  "lhs"
)
"inner_join"
rel70 <- duckdb$rel_set_alias(
  rel68,
  "rhs"
)
"inner_join"
...
"select"
rel77 <- duckdb$rel_from_df(con, df1)
"select"
...
"inner_join"
rel79 <- duckdb$rel_set_alias(
  rel76,
  "lhs"
)
"inner_join"
rel80 <- duckdb$rel_set_alias(
  rel78,
  "rhs"
)
"inner_join"
