...
benchmark_run(
  expr_before_benchmark = {
    ...
    customer <- as_duckplyr_df_impl(customer)
    lineitem <- as_duckplyr_df_impl(lineitem)
    nation <- as_duckplyr_df_impl(nation)
    orders <- as_duckplyr_df_impl(orders)
    part <- as_duckplyr_df_impl(part)
    partsupp <- as_duckplyr_df_impl(partsupp)
    region <- as_duckplyr_df_impl(region)
    supplier <- as_duckplyr_df_impl(supplier)
  },
