...
- Merge pull request
  [\#801](https://github.com/tidyverse/duckplyr/issues/801) from
  jeroenjanssens/supported-by-posit.
...
- New [`as_tbl()`](https://duckplyr.tidyverse.org/reference/as_tbl.md)
...
- [`read_csv_duckdb()`](https://duckplyr.tidyverse.org/reference/read_csv_duckdb.md)
  ...
  [`duckplyr_df_from_csv()`](https://duckplyr.tidyverse.org/reference/df_from_file.md)
  and
  [`df_from_csv()`](https://duckplyr.tidyverse.org/reference/df_from_file.md)
...
- [`db_exec()`](https://duckplyr.tidyverse.org/reference/db_exec.md) to
  execute configuration queries against the default duckdb connection
...
- [`as_duckdb_tibble()`](https://duckplyr.tidyverse.org/reference/duckdb_tibble.md),
  replaces
  [`as_duckplyr_tibble()`](https://duckplyr.tidyverse.org/reference/as_duckplyr_df.md)
  and
...
- [`is_duckdb_tibble()`](https://duckplyr.tidyverse.org/reference/duckdb_tibble.md),
  deprecates
  [`is_duckplyr_df()`](https://duckplyr.tidyverse.org/reference/is_duckplyr_df.md)
...
- New articles:
  ...
  [`vignette("developers")`](https://duckplyr.tidyverse.org/articles/developers.md),
  [`vignette("telemetry")`](https://duckplyr.tidyverse.org/articles/telemetry.md)
...
- [`df_from_file()`](https://duckplyr.tidyverse.org/reference/df_from_file.md)
...
- New
  [`df_to_parquet()`](https://duckplyr.tidyverse.org/reference/df_from_file.md)
  to write to Parquet, new convenience functions
  [`df_from_csv()`](https://duckplyr.tidyverse.org/reference/df_from_file.md),
  `duckdb_df_from_csv()`,
  [`df_from_parquet()`](https://duckplyr.tidyverse.org/reference/df_from_file.md)
