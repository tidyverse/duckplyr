...
FIXME: Move to "large" vignette

Other useful methods include `compute_file()` for storing results in a file, and `compute.duckplyr_df()` for storing results in temporary storage on disk.
...
Funneled duckplyr frames behave like lazy frames in dtplyr and lazy tables dbplyr:
