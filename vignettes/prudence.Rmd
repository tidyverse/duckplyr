...
This article explains how the concept of _prudence_[^1] allows controlling the materialization of data while maintaining a seamless dplyr-like experience.

[^1]: The term "prudence" is introduced here to set a clear distinction from the concept of "laziness" in the context of duckplyr, and because "control of automatic materialization" is a mouthful.
...
See `vignette("large")` for more details on working with large data sets, and `vignette("fallback")` for fallbacks to dplyr.
