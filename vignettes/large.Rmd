...
One examples is the dbplyr package, a dplyr backend that connects to SQL databases and is designed to work with various databases that support SQL, including DuckDB.
...
|-------------|:------------:|:-----------:|
| Speed   |      ✅      |        ✅       |
| Input  |     databases         |      data frames (or files) |
| Output  |     databases         |      data frames (or files)   |
| Syntax|      SQL-flavored dplyr    |      dplyr  |
