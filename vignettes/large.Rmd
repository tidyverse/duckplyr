...
See `vignette("collect")` on eager and lazy data, `vignette("limits")` for limitations in the translation employed by duckplyr, and `?fallback` for more information on fallback.
...
See `vignette("collect")` for more details on the concept of lazy data.
...
See `vignette("collect")` for the concepts and mechanisms at play.
