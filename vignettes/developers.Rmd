...
Use `as_duckdb_tibble(collect = "closed")` or `duckdb_tibble(.collect = "closed")` to avoid materializing intermediate data and to ensure that all operations are carried out by DuckDB or fail.
