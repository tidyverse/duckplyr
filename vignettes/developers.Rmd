...
Use `as_duckdb_tibble(funnel = "frugal")` or `duckdb_tibble(.funnel = "frugal")` to avoid materializing intermediate data and to ensure that all operations are carried out by DuckDB or fail.
