...
Use `as_duckdb_tibble(inert = "always")` or `duckdb_tibble(.inert = "always")` to avoid materializing intermediate data and to ensure that all operations are carried out by DuckDB or fail.
