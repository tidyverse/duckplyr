...
Use `as_duckdb_tibble(funnel = "always_manual")` or `duckdb_tibble(.funnel = "always_manual")` to avoid materializing intermediate data and to ensure that all operations are carried out by DuckDB or fail.
